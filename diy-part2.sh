...
if [ $KERNEL_VERSION ] == "5.15";cp myconfig/config.$ROUTER_MODEL.0.5_15 /myconfig/config.$ROUTER_MODEL.0;cp myconfig/config.$ROUTER_MODEL.1.5_15 /myconfig/config.$ROUTER_MODEL.1;cp myconfig/config.$ROUTER_MODEL.2.5_15 /myconfig/config.$ROUTER_MODEL.2;cp myconfig/config.$ROUTER_MODEL.3.5_15 /myconfig/config.$ROUTER_MODEL.3;fi
