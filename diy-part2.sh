...
rm $GITHUB_WORKSPACE/x-wrt/package/firmware/wireless-regdb/patches/600-*.patch
...
cp $GITHUB_WORKSPACE/patches/600-custom-change-txpower-and-dfs_kernel5.15.patch $GITHUB_WORKSPACE/x-wrt/package/firmware/wireless-regdb/patches/
